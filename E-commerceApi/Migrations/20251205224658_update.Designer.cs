...
namespace E_commerceApi.Migrations
{
    ...
    [Migration("20251205224658_update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_commerceApi.Models.City", b =>
                {
            ...
            modelBuilder.Entity("E_commerceApi.Models.Favorite", b =>
                {
            ...
            modelBuilder.Entity("E_commerceApi.Models.Hotel", b =>
                {
                    b.Property<int>("HotelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("E_commerceApi.Models.Reservation", b =>
                {
                    b.Property<int>("ReservationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("E_commerceApi.Models.SearchHistory", b =>
                {
            ...
            modelBuilder.Entity("E_commerceApi.Models.Favorite", b =>
                {
                    b.HasOne("E_commerceApi.Models.Hotel", "Hotel")
                        .WithMany("Favorites")
            ...
            modelBuilder.Entity("E_commerceApi.Models.Hotel", b =>
                {
                    b.HasOne("E_commerceApi.Models.City", "CityNavigation")
                        .WithMany("Hotels")
            ...
            modelBuilder.Entity("E_commerceApi.Models.Payment", b =>
                {
                    b.HasOne("E_commerceApi.Models.Reservation", "Reservation")
                        .WithMany("Payments")
